...
$router->group(['middleware' => ['jsonApiContentType','throttle:60,1','log']], function (Router $router) {
...
$router->group(['prefix' => 'api', 'middleware' => ['jsonApiContentType','throttle:120,1','log']], function (Router $router) {
    /**
